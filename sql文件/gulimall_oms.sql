...
VALUES (1, 3, '202007101511435951281486241929375746', NULL, '2020-07-10 07:11:44', 'firenayfly', 8888.0000, 8893.0000,
        5.0000, 0.0000, 0.0000, 0.0000, NULL, NULL, NULL, 4, NULL, NULL, 7, 0, 0, NULL, NULL, NULL, NULL,
        'xxx@gmail.com', 'firenayfly', '15421564125', NULL, '陕西', '西安', NULL, '新城区', NULL, NULL, 0, NULL, NULL,
        '2020-07-10 07:11:44', '2020-07-10 07:11:44', '2020-07-10 07:11:44', '2020-07-10 07:11:44');
INSERT INTO `oms_order`
VALUES (2, 3, '202007102108315951281576033585246209', NULL, '2020-07-10 13:08:32', 'firenayfly', 8888.0000, 8893.0000,
        5.0000, 0.0000, 0.0000, 0.0000, NULL, NULL, NULL, 4, NULL, NULL, 7, 0, 0, NULL, NULL, NULL, NULL,
        'xxx@gmail.com', 'firenayfly', '15421564125', NULL, '陕西', '西安', NULL, '新城区', NULL, NULL, 0, NULL, NULL,
        '2020-07-10 13:08:32', '2020-07-10 13:08:32', '2020-07-10 13:08:32', '2020-07-10 13:08:32');
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '订单项信息'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 1, '202007101511435951281486241929375746', 3, '华为 HUAWEI P40 Pro+ 麒麟990 5G ', NULL, '2', 225, 2,
        ...
        8888.0000, 1, '颜色:流光幻镜;套餐:套餐三', 0.0000, 0.0000, 0.0000, 8888.0000, 8888, 8888);
INSERT INTO `oms_order_item`
VALUES (2, 2, '202007102108315951281576033585246209', 3, '华为 HUAWEI P40 Pro+ 麒麟990 5G ', NULL, '2', 225, 2,
        '华为 HUAWEI P40 Pro+ 麒麟990 5G  流光幻镜 套餐二 麒麟990 5G SoC芯片 5000万超感知徕卡五摄 100倍双目变焦 全网通5G',
        'https://mall-fire.oss-cn-shenzhen.aliyuncs.com/2020-06-05/9915d4a7-9f73-4c71-85cc-65c0b7f644dd_图集2.jpg',
        8888.0000, 1, '颜色:流光幻镜;套餐:套餐三', 0.0000, 0.0000, 0.0000, 8888.0000, 8888, 8888);
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '订单操作历史记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '订单退货申请'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '退货原因'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '订单配置信息'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '支付信息表'
  ROW_FORMAT = Dynamic;
...
VALUES (1, '202007051323559261279647175235624962', NULL, '2020070522001473990501031834', 5990.0000, 'glmall',
        'TRADE_SUCCESS', '2020-07-05 05:24:06', NULL, NULL, '2020-07-05 05:24:21');
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '退款信息'
  ROW_FORMAT = Dynamic;
